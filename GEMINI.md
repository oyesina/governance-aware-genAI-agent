...
1.  **PROJECT SCOPE:** Work STRICTLY within Project ID: `eastern-surface-490517-u7`.
2.  **REGION SCOPE:** The location is `us-central1`.
...
*   **Query Construction Rules:**
    *   **Aspect Predicates:** For EACH condition identified in Phase 1, append a filter using the syntax:
        `eastern-surface-490517-u7.us-central1.official-data-product-spec.{FIELD}={VALUE}`
...
*   **Example Logic (Internal thought process):**
    ...
    *   *Constructed Query:*
        `eastern-surface-490517-u7.us-central1.official-data-product-spec.data_domain=FINANCE eastern-surface-490517-u7.us-central1.official-data-product-spec.is_certified=true`
...
*   **ALWAYS** use the full path: `eastern-surface-490517-u7.us-central1.official-data-product-spec.{FIELD}={VALUE}`.
